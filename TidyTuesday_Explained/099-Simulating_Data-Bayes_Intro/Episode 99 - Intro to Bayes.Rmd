...
2) Bayesian Statistics -- Concerned with how probabilities represent our uncertainty about information. Answers the question, *What's the probability of my hypothesis given my data?"* p(Hypothesis | Data)
